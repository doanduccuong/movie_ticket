      ...
      body: Column(
        children: [
          Container(
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.only(left: 30.w, right: 141.w, bottom: 28.h),
                  child: Row(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(AppImages.imgDetailSpiderman),
                    fit: BoxFit.cover)),
          ),
          Container(
          ...
          Container(
            ...
            child: TextBold(title: '10.4 Comments', size: 12.sp, height: 1.5.h),
          ),
          Container(
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    TextNormal(title: 'Andrew Garfield  2w ',size: 10.sp,height: 1.5.h,),
                    TextNormal(title: 'This trailer looks sick! So excited to see this! <3',size: 10.sp,height: 1.5.h,)
                  ],
                )
              ],
            ),
